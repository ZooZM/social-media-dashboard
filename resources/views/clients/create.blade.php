...
<div class="max-w-5xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Create a new client profile with services and business information</p>
    </div>

    <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data" x-data="clientForm()">
        @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="business_category" id="business_category" value="{{ old('business_category') }}" 
                        placeholder="e.g., Real Estate, Restaurant, Fashion" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div x-show="logoPreview" class="w-20 h-20 rounded-lg overflow-hidden border-2 border-gray-200">
                        ...
                        <label class="flex-1 flex items-center justify-center px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-brand-500 transition-colors">
                            <div class="text-center">
                                ...
                                <span class="mt-2 block text-sm text-gray-600">Upload brand logo</span>
                            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-0.5">Add services your business offers</p>
                </div>
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="flex items-center gap-4">
                                    <template x-if="service.imagePreview">
                                        <img :src="service.imagePreview" alt="Service image preview" class="w-16 h-16 rounded-lg object-cover border border-gray-200">
                                    </template>
                                    <input type="file" :name="'service_images[' + index + ']'" accept="image/*" @change="previewServiceImage($event, index)"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 text-sm bg-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-brand-50 file:text-brand-700 hover:file:bg-brand-100">
                                </div>
                            </div>
                            ...
                            <div class="space-y-1.5 max-h-48 overflow-y-auto">
                                <template x-if="publicComments.inquiry_can_dm.length === 0">
                                    <div class="py-4 text-center">
                                        <p class="text-xs text-indigo-300">No templates yet</p>
                                    </div>
                                </template>
                        ...
                        <div class="bg-orange-50 border border-orange-200 rounded-xl p-4">
                            ...
                            <div class="space-y-1.5 max-h-48 overflow-y-auto">
                                <template x-if="publicComments.inquiry_no_dm.length === 0">
                                    <div class="py-4 text-center">
                                        <p class="text-xs text-orange-300">No templates yet</p>
                                    </div>
                                </template>
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                            ...
                            <div class="space-y-1.5 max-h-48 overflow-y-auto">
                                <template x-if="publicComments.engagement.length === 0">
                                    <div class="py-4 text-center">
                                        <p class="text-xs text-green-300">No templates yet</p>
                                    </div>
                                </template>
...
function clientForm() {
    return {
        ...
        businessInfo: {
            ...
            working_hours: [],  // Array of time slots with start_time, end_time, and days
            payment_methods: {
                type: 'cash',  // cash | specific | installment
                specific_methods: [],
                installments: [],
                other: ''
            },
